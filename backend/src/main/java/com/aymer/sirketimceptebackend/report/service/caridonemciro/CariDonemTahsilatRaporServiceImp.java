...
public class CariDonemTahsilatRaporServiceImp extends AbstractAsenkronVeriHazirlamaRaporServiceImp implements CariDonemTahsilatRaporService {
    ...
    @Autowired
    public CariDonemTahsilatRaporServiceImp(AsenkronRaporGeneratorService asenkronRaporGeneratorService, AsenkronRaporBilgiRepository asenkronRaporBilgiRepository) {
    ...
    public List sorguSonucuGetir(AsenkronRaporBilgi asenkronRaporBilgi) {
        ...
        return reportRepository.cariTahsilatDonemList(sorguKriteri.getDonem(), sorguKriteri.getYil(), EDurum.AKTIF, EOdemeYonu.ALACAK, asenkronRaporBilgi.getSirket());
    }
