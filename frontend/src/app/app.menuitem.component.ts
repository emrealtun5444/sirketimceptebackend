...
@Component({
  ...
  template: `
    <ng-container>
      <a [attr.href]="item.url" (click)="itemClick($event)" *ngIf="renderItem(item) && (!item.routerLink || item.items)"
...
export class AppMenuitemComponent implements OnInit, OnDestroy {
  ...
  constructor(private tokenStorage: TokenStorageService, public app: AppMainComponent, public router: Router, private cd: ChangeDetectorRef, private menuService: MenuService) {
