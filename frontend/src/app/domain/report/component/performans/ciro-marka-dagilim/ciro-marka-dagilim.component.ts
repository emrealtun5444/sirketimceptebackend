...
export class CiroMarkaDagilimComponent extends AbstractBaseComponent implements OnInit {
    ...
    ngOnInit(): void {
        this.subscribeToResponseBase(this.reportService.onDonemCiroMarkaDagilim(this.year, this.userName ? this.userName : 'all', (this.cariKart ? this.cariKart.toString() : 'all')), this.onDonemCiroMarkaDagilim, undefined);
    }
